...
export const mockUsers = [
    ...
    { id: 2, name: 'Normal User', email: 'user@example.com', role: 'TOURIST', password: 'user@123' },
    { id: 3, name: 'Editor User', email: 'editor@example.com', role: 'EDITOR', password: 'editor@123' }
];
